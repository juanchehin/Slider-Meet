...
export const handlePreOfferAnswer = (data) => {
    ...
    console.log(data);
    ui.removeAllDialogs();
    console.log("Pregunto segun el caso... preOfferAnswer es : ", preOfferAnswer);
    console.log("Constants.preOfferAnswer.CALLEE_NOT_FOUND es : ", constants.preOfferAnswer.CALLEE_NOT_FOUND);

    console.log("El tipo de dato de preOfferAnswer es : ", typeof preOfferAnswer);
    console.log("El tipo de dato de Constants.preOfferAnswer.CALLEE_NOT_FOUND es : ", typeof constants.preOfferAnswer.CALLEE_NOT_FOUND);
    console.log("strcmp es : ", strcmp(preOfferAnswer, constants.preOfferAnswer.CALLEE_NOT_FOUND));

    if (strcmp(preOfferAnswer, constants.preOfferAnswer.CALLEE_NOT_FOUND) == 0) {
        console.log("pre offer CALLEE_NOT_FOUND");
    ...
    if (preOfferAnswer === constants.preOfferAnswer.CALL_UNAVAILABLE) {
        console.log("pre offer CALL_UNAVAILABLE");
        ui.showInfoDialog(preOfferAnswer);

    }

    if (preOfferAnswer === constants.preOfferAnswer.CALL_REJECTED) {
        console.log("pre offer CALL_REJECTED");
        ui.showInfoDialog(preOfferAnswer);
        // show dialog that call is rejected by the callee
    }

    if (preOfferAnswer === constants.preOfferAnswer.CALL_ACCEPTED) {
        console.log("pre offer CALL_ACCEPTED");
        ui.showCallElements(connectedUserDetails.callType);
        createPeerConnection();
        sendWebRTCOffer();
    }
